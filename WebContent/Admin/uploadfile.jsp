...
<body>
	...
	<b>上传文件</b>
			...
			<div class="jFiler jFiler-theme-default">
			 ...
			 <!-- <input type="text"  maxlength="100" class="form-control" id="depict" name="depict" placeholder="说明" required> -->
...
<script src="folders/js/custom.js" type="text/javascript"></script>
</html>